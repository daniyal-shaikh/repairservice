...
Route::get('login-view','LoginController@checklogin');
...
//--------------------------user----------------------------------
Route::get('/','FindProductIssuePriceController@index_find_price');
...
Route::get('get-search-history','UserHistoryController@getsearchhistory');
Route::get('del-history/{uid}','UserHistoryController@delhistory');
